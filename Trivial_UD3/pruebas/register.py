...
def save_credentials(email, password, username):
    ...
    users.append({"email": email, "usuario": username, "contrasenya": password})
...
def check_credentials(email, password):
    ...
    for user in users:
        if user["email"] == email and user["contrasenya"] == password:
